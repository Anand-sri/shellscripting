...
STAT $? "installed nodejs"


INFO "user add roboshop"
useradd roboshop
STAT $? "user added roboshop"

INFO "download the Catalogue schema "
su roboshop
...
sed -i -e "s/MONGO_DNSNAME/172.31.63.145/" /home/roboshop/catalogue/systemd.service
